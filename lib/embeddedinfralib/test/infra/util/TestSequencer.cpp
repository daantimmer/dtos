...
class TestSequencer: public testing::StrictMock<testing::Test>
{
public:
    MOCK_METHOD0(a, void());
    MOCK_METHOD0(b, void());
...
TEST_F(TestSequencer, executing_one_step_results_in_not_Finished)
{
    ...
    sequencer.Load([this]() { sequencer.Step([this]() { a(); }); });
...
TEST_F(TestSequencer, executing_Execute_results_in_Finished)
{
    ...
    sequencer.Load([this]() { sequencer.Execute([this]() { a(); }); });
...
{
    EXPECT_CALL(*this, condition()).WillOnce(testing::Return(true)).WillOnce(testing::Return(false));
    EXPECT_CALL(*this, a());
    EXPECT_CALL(*this, b());
