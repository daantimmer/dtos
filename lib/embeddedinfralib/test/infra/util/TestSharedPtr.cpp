...
TEST_F(SharedPtrTest, convert_SharedPtr_to_and_from_base)
{
    ...
    infra::SharedPtr<MySharedObject> movedDerivedObject(
        infra::StaticPointerCast<MySharedObject>(std::move(baseObject)));
...
{
    infra::SharedObjectAllocatorFixedSize<MySharedObject, void(infra::ConstructionMonitorMock&)>::WithStorage<1>
        allocator;
...
{
    infra::SharedObjectAllocatorFixedSize<MultiInheritedClass, void(infra::ConstructionMonitorMock&)>::WithStorage<2>
        allocator;
    void* savedObject;
...
{
    struct Object: public infra::EnableSharedFromThis<Object>
    {};
