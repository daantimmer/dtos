...
class MyObserver: public infra::Observer<MyObserver, MySubject>
{
public:
    MyObserver() = default;
...
class MySubject: public infra::Subject<MyObserver>
{};

class MySingleSubject;

class MySingleObserver: public infra::SingleObserver<MySingleObserver, MySingleSubject>
{
public:
...
class MySingleSubject: public infra::Subject<MySingleObserver>
{};
