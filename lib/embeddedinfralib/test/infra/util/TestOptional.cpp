...
TEST(OptionalTest, TestTransformOptional)
{
    ...
    EXPECT_EQ(infra::MakeOptional(5), infra::TransformOptional(infra::MakeOptional(true), [](bool) { return 5; }));
    EXPECT_EQ(infra::none, infra::TransformOptional(empty, [](bool) { return 5; }));
}
...
struct PolymorphicBoolDescendant: PolymorphicBool
{
...
{
    bool value(true);
    infra::OptionalForPolymorphicObjects<PolymorphicBool, sizeof(void*)> o(infra::InPlaceType<PolymorphicBool>(),
                                                                           value);
    EXPECT_TRUE(static_cast<bool>(o));
    EXPECT_TRUE(*o);
}
...
{
    infra::OptionalForPolymorphicObjects<PolymorphicBoolDescendant, 0> descendant(
        infra::InPlaceType<PolymorphicBoolDescendant>(),
        true);
...
TEST(OptionalForPolymorphicObjectsTest, TestCompare)
{
    ...
    infra::OptionalForPolymorphicObjects<PolymorphicBool, sizeof(void*)> f(infra::InPlaceType<PolymorphicBool>(),
                                                                           false);
