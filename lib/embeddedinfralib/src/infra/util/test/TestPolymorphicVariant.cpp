...
namespace
{
    ...
    class CopyableState1: public CopyableState
    {
    public:
        virtual int Identifier() const override
        {
    ...
    class CopyableState2: public CopyableState
    {
    public:
        virtual int Identifier() const override
        {
    ...
    class ComparableState1: public State
    {
    public:
        bool operator==(const ComparableState1&) const
        {
            return true;
        }
    ...
    class ComparableState2: public State
    {
    public:
        bool operator==(const ComparableState2&) const
        {
            return true;
        }
