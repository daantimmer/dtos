...
class Peripheral: public PeripheralInterface
{
public:
    void Send()
    {
...
class PeripheralWithTwoParameters: public PeripheralInterface
{
public:
...
{
    infra::Creator<PeripheralInterface, PeripheralWithTwoParameters, void()> creator(
        [](infra::Optional<PeripheralWithTwoParameters>& object) { object.Emplace(5, 6); });
...
{
    infra::Creator<PeripheralInterface, PeripheralWithTwoParameters, void(int)> creator(
        [](infra::Optional<PeripheralWithTwoParameters>& object, int x) { object.Emplace(x, 6); });
...
{
    infra::Creator<PeripheralInterface, PeripheralWithTwoParameters, void(int)> creator(
        [](infra::Optional<PeripheralWithTwoParameters>& object, int y) { object.Emplace(5, y); });
...
TEST(ProxyCreatorTest, CreatePeripheralByCreatorExternal)
{
    ...
    infra::CreatorExternal<PeripheralInterface, void()> creator(
        [&peripheral, &construction]() -> PeripheralWithTwoParameters& {
            construction.callback();
            return peripheral;
        },
        [&destruction]() { destruction.callback(); });
...
TEST(ProxyCreatorTest, CreateVoidByCreatorExternal)
{
    ...
    PeripheralWithTwoParameters peripheral(5, 6);
    infra::CreatorExternal<void, void()> creator([&construction]() { construction.callback(); },
                                                 [&destruction]() { destruction.callback(); });
