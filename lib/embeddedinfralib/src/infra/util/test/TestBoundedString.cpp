...
TEST(BoundedStringTest, TestConstructedEmpty)
{
    ...
    EXPECT_EQ(0u, string.size());
    EXPECT_EQ(5u, string.max_size());
}
...
TEST(BoundedStringTest, TestCopy)
{
    char buffer[3];
    infra::BoundedString::WithStorage<5> string("abcde");
    EXPECT_EQ(3u, string.copy(buffer, 3, 1));
...
TEST(BoundedStringTest, TestFind)
{
    ...
    EXPECT_EQ(3u, string.find("def"));
    EXPECT_EQ(3u, string.find(searchString));
}
...
TEST(BoundedStringTest, TestRFind)
{
    infra::BoundedString::WithStorage<10> searchString("def");
    infra::BoundedString::WithStorage<10> string("abcdefgh");
    EXPECT_EQ(3u, string.rfind("def"));
    EXPECT_EQ(3u, string.rfind(searchString));
    EXPECT_EQ(3u, string.rfind('d'));
}
...
TEST(BoundedStringTest, TestFindFirstOf)
{
    ...
    infra::BoundedString::WithStorage<5> string("abcde");
    EXPECT_EQ(1u, string.find_first_of(search));
    EXPECT_EQ(1u, string.find_first_of(searchString));
    EXPECT_EQ(1u, string.find_first_of('b'));
}
...
TEST(BoundedStringTest, TestFindFirstNotOf)
{
    ...
    infra::BoundedString::WithStorage<5> string("abcde");
    EXPECT_EQ(1u, string.find_first_not_of(search));
    EXPECT_EQ(1u, string.find_first_not_of(searchString));
    EXPECT_EQ(1u, string.find_first_not_of('a'));
}
...
TEST(BoundedStringTest, TestFindLastOf)
{
    ...
    infra::BoundedString::WithStorage<5> string("abcde");
    EXPECT_EQ(3u, string.find_last_of(search));
    EXPECT_EQ(3u, string.find_last_of(searchString));
}
...
TEST(BoundedStringTest, TestFindLastNotOf)
{
    char search[] = "dce";
    infra::BoundedString::WithStorage<5> string("abcde");
    EXPECT_EQ(1u, string.find_last_not_of(search));
    EXPECT_EQ(3u, string.find_last_not_of('e'));
}
...
TEST(BoundedStringTest, TestStringAsByteRange)
{
    ...
    EXPECT_EQ(infra::MemoryRange<uint8_t>(reinterpret_cast<uint8_t*>(string.begin()),
                                          reinterpret_cast<uint8_t*>(string.end())),
              StringAsByteRange(string));
    EXPECT_EQ(
        infra::MemoryRange<const uint8_t>(reinterpret_cast<const uint8_t*>(string.begin()),
