...
namespace infra
{
    ...
    public:
        ...
        std::tuple<T*, T*, T**> remove_from_tree(
            reference value); // Returns the node replacing the removed node, the parent of the replacing node before
                              // replacing, and a pointer to the parent's left or right where the old replacing node was
    ...
    template <class T, class Compare>
    IntrusiveBinarySearchTree<T, Compare>&
        IntrusiveBinarySearchTree<T, Compare>::operator=(IntrusiveBinarySearchTree&& other)
    {
        clear();
    ...
    template <class T, class Compare>
    typename IntrusiveBinarySearchTree<T, Compare>::const_reverse_iterator
        IntrusiveBinarySearchTree<T, Compare>::rbegin() const
    {
    ...
    template <class T, class Compare>
    typename IntrusiveBinarySearchTree<T, Compare>::const_reverse_iterator
        IntrusiveBinarySearchTree<T, Compare>::rend() const
    {
    ...
    template <class T, class Compare>
    typename IntrusiveBinarySearchTree<T, Compare>::const_reverse_iterator
        IntrusiveBinarySearchTree<T, Compare>::crbegin() const
    {
        return rbegin();
    }
    ...
    template <class T, class Compare>
    typename IntrusiveBinarySearchTree<T, Compare>::const_reverse_iterator
        IntrusiveBinarySearchTree<T, Compare>::crend() const
    {
        return rend();
    }
    ...
    template <class T, class Compare>
    typename IntrusiveBinarySearchTree<T, Compare>::iterator
        IntrusiveBinarySearchTree<T, Compare>::find(const_reference value)
    {
        return iterator(find_in_tree(value), *this);
    }

    template <class T, class Compare>
    typename IntrusiveBinarySearchTree<T, Compare>::const_iterator
        IntrusiveBinarySearchTree<T, Compare>::find(const_reference value) const
    {
    ...
    namespace detail
    {
        ...
        IntrusiveBinarySearchTreeNode<T>&
            IntrusiveBinarySearchTreeNode<T>::operator=(const IntrusiveBinarySearchTreeNode& other)
        {
            return *this;
        }
        ...
        template <class T, class Compare>
        IntrusiveBinarySearchTreeIterator<T, Compare>::IntrusiveBinarySearchTreeIterator(const T* node,
                                                                                         const TreeType& tree)
            : node(node)
            , tree(&tree)
        {}
        ...
        template <class T2>
        IntrusiveBinarySearchTreeIterator<T, Compare>::IntrusiveBinarySearchTreeIterator(
            const IntrusiveBinarySearchTreeIterator<T2, Compare>& other)
            : node(other.node)
            , tree(other.tree)
        {}
        ...
        template <class T, class Compare>
        template <class T2>
        bool IntrusiveBinarySearchTreeIterator<T, Compare>::operator==(
            const IntrusiveBinarySearchTreeIterator<T2, Compare>& other) const
        {
