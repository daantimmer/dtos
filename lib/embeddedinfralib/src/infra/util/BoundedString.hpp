...
namespace infra
{
    ...
    public:
        ...
        BoundedStringBase(MemoryRange<NonConstT> range,
                          const BoundedStringBase& other,
                          size_type pos,
                          size_type count = BoundedStringBase::npos);
    ...
    public:
        ...
        BoundedStringBase&
            insert(size_type index, const BoundedStringBase& other, size_type index_str, size_type count);
        ...
        template <class U>
        BoundedStringBase& replace(size_type pos,
                                   size_type count,
                                   const BoundedStringBase<U>& other,
                                   size_type pos2,
                                   size_type count2);
        template <class InputIterator>
        BoundedStringBase&
            replace(const_iterator first, const_iterator last, InputIterator first2, InputIterator last2);
    ...
    private:
        ...
        template <class U>
        static void AssignToRange(MemoryRange<NonConstT> range,
                                  size_type& length,
                                  const BoundedStringBase<U>& other,
                                  size_type pos,
                                  size_type count);
        ...
        template <class InputIterator>
        static void
            AssignToRange(MemoryRange<NonConstT> range, size_type& length, InputIterator first, InputIterator last);
    ...
    BoundedStringBase<T>::BoundedStringBase(MemoryRange<NonConstT> range,
                                            const BoundedStringBase<T>& other,
                                            size_type pos,
                                            size_type count)
        : range(range)
    {
    ...
    template <class U>
    BoundedStringBase<T>&
        BoundedStringBase<T>::assign(const BoundedStringBase<U>& other, size_type pos, size_type count)
    {
        AssignToRange(range, length, other, pos, count);
    ...
    template <class T>
    BoundedStringBase<T>& BoundedStringBase<T>::insert(size_type index,
                                                       const BoundedStringBase<T>& other,
                                                       size_type index_str,
                                                       size_type count)
    {
    ...
    template <class T>
    BoundedStringBase<T>&
        BoundedStringBase<T>::insert(size_type index, const std::string& other, size_type index_str, size_type count)
    {
    ...
    template <class U>
    BoundedStringBase<T>&
        BoundedStringBase<T>::append(const BoundedStringBase<U>& other, size_type pos, size_type count)
    {
        assert(length + count <= max_size());
    ...
    template <class T>
    int BoundedStringBase<T>::compare(size_type pos1,
                                      size_type count1,
                                      const BoundedStringBase<T>& other,
                                      size_type pos2,
                                      size_type count2) const
    {
        return CompareImpl(begin() + pos1,
                           begin() + pos1 + count1,
                           other.begin() + pos2,
                           other.begin() + pos2 + count2);
    }
    ...
    template <class U>
    BoundedStringBase<T>&
        BoundedStringBase<T>::replace(size_type pos, size_type count, const BoundedStringBase<U>& other)
    {
    ...
    template <class U>
    BoundedStringBase<T>&
        BoundedStringBase<T>::replace(const_iterator first, const_iterator last, const BoundedStringBase<U>& other)
    {
    ...
    template <class T>
    template <class U>
    BoundedStringBase<T>& BoundedStringBase<T>::replace(size_type pos,
                                                        size_type count,
                                                        const BoundedStringBase<U>& other,
                                                        size_type,
                                                        size_type count2)
    ...
    template <class T>
    BoundedStringBase<T>&
        BoundedStringBase<T>::replace(size_type pos, size_type count, const char* cstr, size_type count2)
    {
    ...
    template <class T>
    BoundedStringBase<T>&
        BoundedStringBase<T>::replace(const_iterator first, const_iterator last, const char* cstr, size_type count2)
    {
    ...
    template <class T>
    BoundedStringBase<T>&
        BoundedStringBase<T>::replace(size_type pos, size_type count, const std::string& s, size_type count2)
    {
    ...
    template <class T>
    BoundedStringBase<T>&
        BoundedStringBase<T>::replace(const_iterator first, const_iterator last, const std::string& s, size_type count2)
    {
    ...
    template <class T>
    BoundedStringBase<T>&
        BoundedStringBase<T>::replace(const_iterator first, const_iterator last, size_type count2, char ch)
    {
    ...
    template <class T>
    template <class U>
    typename BoundedStringBase<T>::size_type BoundedStringBase<T>::find(const BoundedStringBase<U>& other,
                                                                        size_type pos) const
    {
    ...
    template <class T>
    typename BoundedStringBase<T>::size_type
        BoundedStringBase<T>::find(const char* s, size_type pos, size_type count) const
    {
        assert(pos <= length);
    ...
    template <class T>
    template <class U>
    typename BoundedStringBase<T>::size_type BoundedStringBase<T>::rfind(const BoundedStringBase<U>& other,
                                                                         size_type pos) const
    {
    ...
    template <class T>
    typename BoundedStringBase<T>::size_type
        BoundedStringBase<T>::rfind(const char* s, size_type pos, size_type count) const
    {
        pos = std::min(pos, length);
    ...
    template <class T>
    template <class U>
    typename BoundedStringBase<T>::size_type BoundedStringBase<T>::find_first_of(const BoundedStringBase<U>& other,
                                                                                 size_type pos) const
    {
    ...
    template <class T>
    typename BoundedStringBase<T>::size_type
        BoundedStringBase<T>::find_first_of(const char* s, size_type pos, size_type count) const
    {
        pos = std::min(pos, length);
    ...
    template <class T>
    template <class U>
    typename BoundedStringBase<T>::size_type BoundedStringBase<T>::find_first_not_of(const BoundedStringBase<U>& other,
                                                                                     size_type pos) const
    {
    ...
    template <class T>
    typename BoundedStringBase<T>::size_type
        BoundedStringBase<T>::find_first_not_of(const char* s, size_type pos, size_type count) const
    {
        pos = std::min(pos, length);
        for (const_iterator i = begin() + pos; i != end(); ++i)
            if (std::find(s, s + count, *i) == s + count)
    ...
    template <class T>
    template <class U>
    typename BoundedStringBase<T>::size_type BoundedStringBase<T>::find_last_of(const BoundedStringBase<U>& other,
                                                                                size_type pos) const
    {
    ...
    template <class T>
    typename BoundedStringBase<T>::size_type
        BoundedStringBase<T>::find_last_of(const char* s, size_type pos, size_type count) const
    {
        pos = std::min(pos, length);
    ...
    template <class T>
    template <class U>
    typename BoundedStringBase<T>::size_type BoundedStringBase<T>::find_last_not_of(const BoundedStringBase<U>& other,
                                                                                    size_type pos) const
    {
    ...
    template <class T>
    typename BoundedStringBase<T>::size_type
        BoundedStringBase<T>::find_last_not_of(const char* s, size_type pos, size_type count) const
    {
        pos = std::min(pos, length);
        for (const_iterator i = begin() + pos - 1; i >= begin(); --i)
            if (std::find(s, s + count, *i) == s + count)
    ...
    template <class T>
    void BoundedStringBase<T>::AssignToRange(infra::MemoryRange<NonConstT> range,
                                             size_type& length,
                                             size_type count,
                                             char ch)
    {
    ...
    template <class T>
    int BoundedStringBase<T>::CompareImpl(const char* begin1,
                                          const char* end1,
                                          const char* begin2,
                                          const char* end2) const
    {
    ...
    template <class T>
    template <class InputIterator>
    typename BoundedStringBase<T>::iterator
        BoundedStringBase<T>::insert(const_iterator i, InputIterator first, InputIterator last)
    {
    ...
    template <class T>
    template <class InputIterator>
    BoundedStringBase<T>& BoundedStringBase<T>::replace(const_iterator first,
                                                        const_iterator last,
    ...
    bool operator==(const char* lhs, const BoundedStringBase<T>& rhs)
    {
        return std::strlen(lhs) == rhs.size() && std::equal(rhs.begin(), rhs.end(), lhs);
    }

    template <class T>
    bool operator==(const BoundedStringBase<T>& lhs, const char* rhs)
    {
        return lhs.size() == std::strlen(rhs) && std::equal(lhs.begin(), lhs.end(), rhs);
    }
    ...
    bool CaseInsensitiveCompare(const infra::BoundedStringBase<T>& lhs, const infra::BoundedStringBase<U>& rhs)
    {
        return lhs.size() == rhs.size() && std::equal(std::begin(lhs), std::end(lhs), std::begin(rhs), [](T a, U b) {
    ...
    bool CaseInsensitiveCompare(const infra::BoundedStringBase<T>& lhs, const char* rhs)
    {
        return lhs.size() == std::strlen(rhs) && std::equal(std::begin(lhs), std::end(lhs), rhs, [](T a, T b) {
                   return std::tolower(a) == std::tolower(b);
               });
    }
    ...
    MemoryRange<const T> StringAsMemoryRange(const infra::BoundedStringBase<const U>& string)
    {
        return MemoryRange<const T>(reinterpret_cast<const T*>(string.begin()),
                                    reinterpret_cast<const T*>(string.end()));
    }
