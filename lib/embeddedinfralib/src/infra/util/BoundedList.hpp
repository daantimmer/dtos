...
namespace infra
{
    ...
    public:
        ...
        using WithMaxSize
            = infra::WithStorage<BoundedList<T>, std::array<StaticStorage<detail::BoundedListNode<T>>, Max>>;
    ...
    public:
        ...
        BoundedList(infra::MemoryRange<infra::StaticStorage<detail::BoundedListNode<T>>> storage,
                    size_type n,
