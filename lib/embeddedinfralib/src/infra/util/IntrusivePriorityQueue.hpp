...
namespace infra
{
    ...
    public:
        ...
        IntrusivePriorityQueue(InputIterator first,
                               InputIterator last,
                               const Compare& comp = Compare()); // TICS !INT#022
    ...
    template <class T, class Compare>
    template <class InputIterator>
    IntrusivePriorityQueue<T, Compare>::IntrusivePriorityQueue(InputIterator first,
                                                               InputIterator last,
                                                               const Compare& comp)
        : compare(comp)
    {
    ...
    void IntrusivePriorityQueue<T, Compare>::erase(const T& position)
    {
        ...
        {
            assert(
                last.up); // if last.up does not exist, then the tree holds only one element, and &last == &erasingNode
            assert(erasingNode.up); // if erasingNode.up does not exist, then the tree holds only one element, and &last
                                    // == &erasingNode
    ...
    namespace detail
    {
        ...
        template <class T>
        IntrusivePriorityQueueNode<T>::IntrusivePriorityQueueNode(const IntrusivePriorityQueueNode&)
            : up(nullptr)
            , left(nullptr)
            , right(nullptr)
        {}
        ...
        template <class T>
        IntrusivePriorityQueueNode<T>& IntrusivePriorityQueueNode<T>::operator=(const IntrusivePriorityQueueNode&)
        {
            return *this;
        }
    }
