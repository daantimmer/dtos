...
namespace infra
{
    ...
    namespace detail
    {
        ...
        public:
            ...
            explicit IntrusiveForwardListIterator(
                const IntrusiveForwardListNode<typename std::remove_const<T>::type>* node);
    ...
    namespace detail
    {
        ...
        template <class T>
        template <class T2>
        IntrusiveForwardListIterator<T>&
            IntrusiveForwardListIterator<T>::operator=(const IntrusiveForwardListIterator<T2>& other)
        {
            mNode = other.mNode;
