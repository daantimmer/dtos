...
namespace infra
{
    ...
    public:
        ...
        using WithMaxSize = infra::WithStorage<BoundedForwardList<T>,
                                               std::array<StaticStorage<detail::BoundedForwardListNode<T>>, Max>>;
    ...
    public:
        ...
        explicit BoundedForwardList(
            infra::MemoryRange<infra::StaticStorage<detail::BoundedForwardListNode<T>>> storage);
        BoundedForwardList(infra::MemoryRange<infra::StaticStorage<detail::BoundedForwardListNode<T>>> storage,
                           size_type n,
        ...
        BoundedForwardList(infra::MemoryRange<infra::StaticStorage<detail::BoundedForwardListNode<T>>> storage,
                           const BoundedForwardList& other);
        BoundedForwardList(infra::MemoryRange<infra::StaticStorage<detail::BoundedForwardListNode<T>>> storage,
                           BoundedForwardList&& other);
        ~BoundedForwardList();
    ...
    namespace detail
    {
        ...
        template <class T>
        template <class T2>
        BoundedForwardListIterator<T>&
            BoundedForwardListIterator<T>::operator=(const BoundedForwardListIterator<T2>& other)
        {
            mNode = other.mNode;
